...
var __1 = require("..");
it("returns a component from a html string", function () {
...
it("returns a component from a html string with a string", function () {
...
it("returns a component from a html string with a number", function () {
    var component = (0, __1.flyg)(templateObject_3 || (templateObject_3 = __makeTemplateObject(["<div>", "</div>"], ["<div>", "</div>"])), 1);
    expect(component.outerHTML).toBe("<div>1</div>");
});
it("returns a component from a html string with boolean", function () {
...
it("returns a component from a html string with multiple values in a row", function () {
...
it("returns a component from a html string with multiple values spread out", function () {
...
it("returns a component from a html string with a component", function () {
...
it("should return a component from a html string with multiple components", function () {
...
it("throws errors if the value is not a component", function () {
